...
<div class="flex h-full mx-2 my-10">
	<div class="min-h-full w-1/6">
		<nav class="flex flex-col w-50 min-h-full mt-5 mx-5 py-2 px-2">
			<a href="/" class="text-sm text-white my-2 p-2 bg-slate-500 border-2 rounded-md ">Home</a>
